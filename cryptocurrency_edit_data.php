...
if (isset($_GET['edit_id'])) {
	$sql_query = "SELECT * FROM cryptocurrency WHERE cryptocurrency_id=" . $_GET['edit_id'];
...
if (isset($_POST['btn-update'])) {
	...
	$sql_query = "UPDATE cryptocurrency SET cryptocurrency_name='$cryptocurrency_name',price='$price',amount='$amount',handlingFee='$handlingFee',cost='$cost',TWD_cost='$TWD_cost',note='$note' WHERE cryptocurrency_id=" . $_GET['edit_id'];
	// sql query for update data into database
...
if (isset($_POST['btn-cancel'])) {
	header("Location: cryptocurrency_main.php");
}
?>
			...
			<div id="content">
				<form method="post">
					<table align="center" style="border: 10px white solid;">
						<tr>
							<td><input type="text" name="cryptocurrency_name" placeholder="貨幣名稱 Cryptocurrency Name" value="<?php echo $fetched_row['cryptocurrency_name']; ?>" required /></td>
						</tr>
						<tr>
						...
						<tr>
							<td><input type="text" name="TWD_cost" placeholder="台幣成本 TWD Cost" value="<?php echo $fetched_row['TWD_cost']; ?>" required /></td>
						</tr>
						<tr>
