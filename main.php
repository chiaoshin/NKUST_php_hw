...
<body>
    <center>
        ...
        $query = "SELECT * FROM bank"; // get the records on which pie chart is to be drawn
                    ...
                    data: [
                        ...
                        if ($getData->num_rows > 0) {
                            while ($row = $getData->fetch_object()) {
                                $data .= '{ name:"' . $row->account_name . '",y:' . $row->amount . '},';
                            }
                        }
                        echo $data;
                        ?>
            ...
            <div id="content">
                <table align="center" style="border: 10px white solid;">
                    <tr>
                        ...
                        <th colspan="5" class="thcolor"><a href="add_data.php" style="background-color:#EAC100;"><span class=" material-symbols-sharp">add</span>新增資料</a></th>
                    </tr>
                    <th style="color:#0072E3;background-color:#EAC100;border: 5px white solid;">【帳戶 Account Name】</th>
                    <th style="color:#0072E3;background-color:#EAC100;border: 5px white solid;">【$金額 Amount】</th>
                    ...
                    $sql_query = "SELECT account_name, user_id, FORMAT(amount,0) AS total, note FROM bank";
                    ...
                    ?>
                            <tr>
                                ...
                                <td align="center"><a href="javascript:edt_id('<?php echo $row[1]; ?>')"><img src="./img/main/b_edit.png" align="EDIT" /></a></td>
                                <td align="center"><a href="javascript:delete_id('<?php echo $row[1]; ?>')"><img src="./img/main/b_drop.png" align="DELETE" /></a></td>
                            </tr>
                        <?php
                        }
                    } else {
