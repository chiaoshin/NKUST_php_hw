				...
				<div class="col-xxl-4 col-xl-5 col-lg-5 col-md-7 col-sm-9">
					...
					<div class="card shadow-lg">
						<div class="card-body p-4">
							...
							<form name="regForm" action="addmember.php" method="POST" class="needs-validation" novalidate="" autocomplete="off">
								<div class="mb-3">
									<div class="input-group mb-3">
										<div class="input-group-prepend">
											<span class="input-group-text" id="basic-addon1">🔒︎</span>
										</div>
										<input id="name" type="text" class="form-control" name="account" value="" placeholder="使用者名稱" required autofocus>
								...
								<div class="mb-3">
									<div class="input-group mb-3">
										...
										<input id="password" type="password" class="form-control" name="psw" placeholder="密碼" required>
										<div class="invalid-feedback">
											密碼 <b>尚未輸入</b>
										</div>
									</div>
						...
						<div class="card-footer py-3 border-0">
							<div class="text-center">
								已經擁有帳號? <a href="login.php" class="text-blue">返回登入</a>
							</div>
						</div>
					</div>
