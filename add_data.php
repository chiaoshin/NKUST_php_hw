...
if (isset($_POST['btn-save'])) {
	...
	$sql_query = "INSERT INTO bank(account_name,amount,note) VALUES('$account_name','$amount','$note')";
	// sql query for inserting data into database
			...
			<div id="content">
				<form method="post">
					<table align="center" style="border: 10px white solid;">
						...
						<tr>
							<td><input type="text" name="account_name" placeholder="帳戶 Account Name" required /></td>
						</tr>
						<tr>
							<td><input type="text" name="amount" placeholder="$金額 Amount" required /></td>
						</tr>
						<tr>
