...
if (isset($_SESSION["login_user"])) {
    ...
    //換此用無痕導致登出有問題bug，會導致登出時，按首頁，上一個帳戶的資料依舊保留。
}
?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="./img/col2.png" class="d-block w-100" alt="col1">
                </div>
                <div class="carousel-item">
                    <img src="./img/col2.png" class="d-block w-100" alt="col2">
                </div>
                <div class="carousel-item">
                    <img src="./img/col2.png" class="d-block w-100" alt="col3">
                </div>
            </div>
            <!-- 左右箭頭 -->
