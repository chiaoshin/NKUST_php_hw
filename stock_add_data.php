...
if (isset($_POST['btn-save'])) {
	...
	$sql_query = "INSERT INTO stock(stock_symbol,stock_name,price,amount,handlingFee,cost,note) VALUES('$stock_symbol','$stock_name','$price','$amount','$handlingFee','$cost','$note')";
	// sql query for inserting data into database
			...
			<div id="content">
				<form method="post">
					<table align="center" style="border: 10px white solid;">
						<tr>
							<td align="center"><a href="main.php">回到該頁 資產紀錄<br>back to main page</a></td>
						</tr>
						<tr>
							<td><input type="text" name="stock_symbol" placeholder="股票代號 Stock Symbol" required /></td>
						</tr>
						<tr>
							<td><input type="text" name="stock_name" placeholder="股票名稱 Stock Name" required /></td>
						</tr>
						<tr>
							<td><input type="text" name="price" placeholder="買入價格 Price" required /></td>
						</tr>
						<tr>
							<td><input type="text" name="amount" placeholder="買入數量(股數) Amount" required /></td>
						</tr>
						<tr>
